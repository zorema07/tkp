...
<div class="container">
	<div class="row">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr bgcolor="">
					    ...
					    <td height="25" align="left" class="col-md-3">{{ $month->name }}&nbsp;</td>
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading">Edit Month</div>
				<div class="panel-body">
					{!! Form::model($monthById, ['route'=>['monthpdf.update',$monthById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
