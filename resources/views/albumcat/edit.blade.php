...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading"><strong>Update Album Category</strong></div>
				<div class="panel-body">
					{!! Form::model($albumCatById,['route'=>['albumcat.update',$albumCatById->id],'method'=>'patch','class'=>'form-horizontal']) !!}
